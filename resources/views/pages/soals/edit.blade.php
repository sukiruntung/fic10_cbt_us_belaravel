                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input id="pertanyaan" type="text" value="{{ $soal->pertanyaan }}"
                                    class="form-control
                                    @error('pertanyaan')
                                            is-invalid
                                        @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <input id="jawaban_a" type="text" value="{{ $soal->jawaban_a }}"
                            ...
                            <div class="form-group">
                                ...
                                <input id="jawaban_b" type="text" value="{{ $soal->jawaban_b }}"
                            ...
                            <div class="form-group">
                                ...
                                <input id="jawaban_c" type="text" value="{{ $soal->jawaban_c }}"
                            ...
                            <div class="form-group">
                                <label>Jawabn D</label>
                                <input id="jawaban_d" type="text" value="{{ $soal->jawaban_d }}"
